...
export const backendCourse: CourseDef = {
  ...
  description:
    "19 уроков в десяти спринтах с подробными объяснениями и множеством примеров: Django и базы данных, Docker и деплой, Elasticsearch и ETL-процессы, Code Review и SOLID, асинхронное программирование и FastAPI, авторизация и аутентификация, микросервисы и устойчивость сервисов, UGC-сервис и большие данные, CI/CD и распределённые системы, сервис нотификаций. Каждый урок содержит аналогии из жизни, пошаговые инструкции и практические задания.",
  accent: "#092e20",
  accent2: "#44b78b",
  levels: [
    {
