-- ============================================================
--  js://master — схема MySQL для хостинга (импорт через phpMyAdmin)
--  База mostnews_studit уже создана в cPanel — выбираем её в
--  phpMyAdmin слева и импортируем этот файл целиком.
-- ============================================================
