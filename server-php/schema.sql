-- ============================================================
--  js://master — таблицы для существующей базы mostnews_studit
--  Применение: phpMyAdmin → база mostnews_studit → вкладка SQL → вставить
-- ============================================================
...
CREATE TABLE IF NOT EXISTS users (
  ...
  password_hash CHAR(60)      NOT NULL COMMENT 'bcrypt (password_hash)',
...
-- data — полный ProgressState фронтенда (JSON-строка):
